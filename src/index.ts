...
export async function buildDigest(data: string | Uint8Array<ArrayBuffer>): Promise<string> {
...
export async function checkDigest(data: string | Uint8Array<ArrayBuffer>, digest: string): Promise<boolean> {
...
export async function enforceDigest(data: string | Uint8Array<ArrayBuffer>, digest: string): Promise<void> {
