...
import BaseCopiable, { type CopiableProps as BaseCopiableProps } from './copiable';
...
export {
    BaseButton, BaseButtonProps, BaseCopiable, BaseCopiableProps, BaseForm, BaseFormProps, BaseInput,
    BaseInputProps, BaseLoader,
    BaseLoaderProps, BaseModal, BaseModalProps, BaseTable, BaseTableProps
};
